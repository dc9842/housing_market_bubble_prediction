...
def download_2014():
    ...
    if(s.shape[0]==1):
        sequenceNum = int(s["Summary File Sequence Number"].values[0])
        print(sequenceNum)
    ...
    fileName = os.path.join(folderAdd,"{}/2014_1yr_Summary_FileTemplates/Seq{}.xls".format(summaryFileTemplates,sequenceNum))
