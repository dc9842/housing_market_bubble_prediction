...
def download_2009():
    ...
    geoURL_file = acsURL + "/1_year_seq_by_state/US/g{}1us.txt".format(year)
    ...
    if(year ==2019):
        ...
        appendicesURL_file =  acsParentURL + "/{}/documentation/1_year/user_tools/merge_5_6.xls".format(year, year)
    ...
    if(year >2013):
        ...
        tableShellURL_file = acsParentURL + "/{}/documentation/1_year/user_tools/ACS{}TableShells.xls".format(year, year)
    ...
    summaryURL_file = acsURL + "/1_year_seq_by_state/US/{}1us0{}000.zip".format(year,sequenceNum)
